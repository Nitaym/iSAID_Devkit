...
__C.TRAIN.FG_THRESH = 0.3 #0.3 #0.5

# Overlap threshold for a ROI to be considered background (class = 0 if
# overlap in [LO, HI))
__C.TRAIN.BG_THRESH_HI = 0.5 #0.5
...
__C.DATA_LOADER.NUM_THREADS = 4 #4
...
__C.TEST.DETECTIONS_PER_IM = 2000 #100
...
__C.TEST.BBOX_AUG.H_FLIP = False #False
...
__C.FPN.EXTRA_CONV_LEVELS = False #False [6-2]
...
# ------------------------------
# Data directory
__C.DATA_DIR = osp.abspath(osp.join(__C.ROOT_DIR, 'preprocess/dataset/iSAID_patches'))
